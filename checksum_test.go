...
func TestChecksumMD5(t *testing.T) {
	err := verifyChecksum(&Checksum{ChecksumMD5,
...
func TestChecksumSHA1(t *testing.T) {
	err := verifyChecksum(&Checksum{ChecksumSHA1,
...
func TestChecksumSHA256(t *testing.T) {
	err := verifyChecksum(&Checksum{ChecksumSHA256,
...
func TestChecksumSHA512(t *testing.T) {
	err := verifyChecksum(&Checksum{ChecksumSHA512,
